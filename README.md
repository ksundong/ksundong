...
- 🌱 I’m currently learning `Ruby On Rails`, `MSA`, `Docker`, `HTML/CSS`
...
- Growth Project(Project Dmart): Focus on `MSA`, `Spring Cloud`, `gRPC`, `Spring Data JPA`, `Dockerizing`, `Real World Domain`
